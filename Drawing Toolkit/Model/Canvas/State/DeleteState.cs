...
namespace Drawing_Toolkit.Model.Canvas.State {
    class DeleteState : CanvasState {
        ...
        private LinkedList<DrawingContext> GetDrawingInEditState(CanvasContext context) {
        ...
        private void RemoveAll(LinkedList<DrawingContext> sourceList, LinkedList<DrawingContext> removedList) {
